...
describe('Country Of Origin - BOM Tree', () => {
    ...
    it('should be Enter Part Number in filter box having multiple Country of origin details and verify country Name', async () => {
    ...
    it('should be Enter Part Number in filter box having multiple Country of origin details and verify overAll calculation is proper', async () => {
        await cooLogic.openCOOPopOverAndVerifyMultipleCountryName(0,0);
        await cooLogic.verifyOverallIndicatorCalcuation();
        await cooLogic.openCOOPopOverAndVerifyMultipleCountryName(0,1);
        await cooLogic.verifyOverallIndicatorCalcuation();
