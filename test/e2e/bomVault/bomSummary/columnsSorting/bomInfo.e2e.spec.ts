...
describe('BOM Summary - BOM Info column', () => {
    ...
    it('should work Autosize this column option', async () => {
        ...
        expect(await JsScripts.returnElementWidthByCssAndNumber(gridElements.newGridHeaderCss, 1))
            .toEqual(114);
    });
    ...
    it('should work Reset columns', async () => {
        ...
        expect(await JsScripts.returnElementWidthByCssAndNumber(gridElements.newGridHeaderCss, colNumber + 1))
            .toEqual(117)
    });
