...
describe('Compare Parts - View Alternates - BOM Tree Parts', () => {
    ...
    it('should open Compare Parts modal and check modal title', async () => {
        ...
        await grid.newGridFilterValueColumnByOption('Internal Part Number',2,'KM311A0.10210160');
        await viewAlternatesLogic.openViewAlternatesModalFromBom(1,'Internal Part Number',true,'KM311A0.10210160');
