...
describe('Part Search by Exact Part # type - Result grid ', () => {
    ...
    beforeEach(async () => {
        ...
        await partsSearchLogic.checkPartNamberRadioButton('Exact Part Number');
        await partsSearchLogic.performPartsSearch(commonSearch.validExactPartNumberValue);
    });

    it('should check column headers for Default layout', async () => {
    ...
    it('should check column headers for Life Cycle layout', async () => {
    ...
    it('should check column headers for Environmental layout', async () => {
    ...
    it('should check column headers for Combined layout', async () => {
